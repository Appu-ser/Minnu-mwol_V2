...
module.exports = {
    ...
    SESSION: process.env.MINNU_SESSION === undefined ? '' : process.env.MINNU_SESSION,
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By Minnu-mwol' : process.env.ALL_CAPTION,
    ...
    MINNUALIVE: process.env.ALIVE_BUTTON === undefined ? 'Hello' : process.env.ALIVE_BUTTON,
    APPUSER: process.env.BUTTON_TWO === undefined ? 'Hii' : process.env.BUTTON_TWO,
    DISBGM: process.env.DISABLE_JID_BGM_FILTER === undefined ? false : process.env.DISABLE_JID_BGM_FILTER,
    BAD_KICK: process.env.BAD_KICK === undefined ? 'true' : process.env.BAD_KICK,
    STICKERP: process.env.AUTO_STICKER === undefined ? true : convertToBool(process.env.AUTO_STICKER),
    DISSTICKER: process.env.DISABLE_STICKER === undefined ? false : process.env.DISABLE_STICKER,
    BOT: process.env.BOT_NAME === undefined ? '⊢‒‒‒ ⋈ Minnu-mwol ⋈ ‒‒‒⊣' : process.env.BOT_NAME,
